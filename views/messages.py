...
class Messages:
    ...
    def message_error(self, table, message_number):
        if message_number == 0:
            ...
            if table == "client":
                self.console.print(
                    "Ce client est inconnu.", style=self.error_style
                )
            if table == "event":
                self.console.print(
                    "Cet évènement est inconnu.", style=self.error_style
                )
            if table == "contract":
                self.console.print(
                    "Ce contrat est inexistant.", style=self.error_style
                )
            if table == "staff":
                self.console.print(
                    "Ce collaborateur est inconnu.", style=self.error_style
                )
